...
test('Profile page displays mocked user name from profile response', async ({ page }) => {
    ...
    await page.route('https://qauto2.forstudy.space/api/users/profile', async (route) => {
    ...
    await expect(profilePage.profileName).toHaveText(`${mockedProfileData.name} undefined`);
});
